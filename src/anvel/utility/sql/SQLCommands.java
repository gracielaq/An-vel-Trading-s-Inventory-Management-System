...
public interface SQLCommands {
	...
	String ADD_SOLD_PRODUCT = "insert into Product(" + "product_code," + "unit_price, " + "quantity,"
			+ "product_description, " + "discount_sell," + "total_amount," + "note_quantity," + "note_description,"
			+ "customer_name," + "tin," + "address," + "date," + "mode_of_payment" + ") values(?,?,?,?,?,?,?,?,?,?,?)";
...
<<<<<<< HEAD
	...
	/*
	 * FOR Products: FOR Products: CREATE TABLE `Product` ( `product_code`
	 * int(11) NOT NULL, `supplier` varchar(200) NOT NULL, `delivery_date`
	 ...
	 * double NOT NULL, `discount_add` double DEFAULT NULL, `total_amount`
	 * double DEFAULT NULL, `mode_of_payment` varchar(45) NOT NULL, PRIMARY KEY
	 * (`product_code`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
	 */
=======
...
<<<<<<< HEAD
	String UPDATE_PRODUCT = "update product set delivery_date=?," + "date_received=?," + "delivery_charge=?,"
			+ "DR_SI=?," + "quantity=?," + "product_description=?," + "unit_price=?," + "discount_add=?,"
			+ "total_amount=?," + "mode_of_payment=?," + "supplier=?" + "where product_code=?";
	...
	String SEARCH_FOR_PRODUCTS = "select * from product where delivery_date like ? OR " + "date_received like ? OR "
			+ "delivery_charge like ? OR " + "DR_SI like ? OR " + "quantity like ? OR "
			+ "product_description like ? OR " + "unit_price like ? OR " + "discount_add like ? OR "
			+ "total_amount like ? OR " + "mode_of_payment like ? OR " + "supplier like ? OR" + " product_code like ?";
=======
