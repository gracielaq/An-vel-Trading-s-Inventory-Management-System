...
@WebServlet("/ViewOld.html")
public class viewOldProd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/ViewOldProducts.jsp").forward(request,response);
	}
